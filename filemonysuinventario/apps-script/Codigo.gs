...
const COL_MOLDES = ['id','codigo','nombre','categoria','claves','medidas','cavidades','columnas',
                    'dias','estado','ubicacion','notas','foto','giro','actualizado'];

const COL_PIEZAS = ['id','idMolde','numero','nombre','claves','existencia','minimo','recorte','actualizado'];
